...
public class SceneGameEngine extends Scene {
	...
	public void gameLoad() {
		font = FontLoader.loadFontWithOutline(FileLoader.get("AGENCYR.ttf"), 110, Color.BLACK, 1, false);
		button = new Button(128, 256, "buti kati");
		button.setSize(100, 20);
		box = new TextField(320, 227, 200, 20);
		checkBox = new Checkbox(256, 192);
		BitmapFont groupFont = FontLoader.loadFontWithOutline(FileLoader.get("arial.ttf"), 16, Color.WHITE, Color.BLACK, 2, false);
		BitmapFont groupFont2 = FontLoader.loadFontWithOutline(FileLoader.get("arial.ttf"), 48, Color.WHITE, Color.BLACK, 2, false);
	...
	public void render() {
		...
		FontUtils.addText(font, "Game Engine v" + Game.GAME_VERSION, Game.RES_WIDTH / 2, 64, FontUtils.ALLIGN_MIDDLE);
